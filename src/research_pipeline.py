...
class ResearchPipeline:
    ...
    def __init__(self, output_dir: str = "artifacts/pipeline"):
        ...
        self.contract: ResearchContract | None = None
        self.feature_set: FeatureSet | None = None
        self.baseline_result: ExperimentResult | None = None
        self.ml_result: ExperimentResult | None = None
        self.wf_report: WalkForwardReport | None = None
        self.enhancer: PortfolioEnhancer | None = None
    ...
    def apply_portfolio_enhancement(self) -> dict:
        ...
        print("组合增强配置:")
        print("  持仓缓冲区: retain_rank=50, max_retain=60%")
        print("  权重平滑: step_ratio=50%")
        print("  成本过滤: min_alpha=0.2%, cost_ratio=30%")
    ...
    def run_walk_forward_validation(self) -> dict | None:
