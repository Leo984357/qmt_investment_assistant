...
class StrategyGate:
    ...
    def evaluate(
        ...
        quantile_summary: Optional[pd.DataFrame] = None,
        trades: Optional[pd.DataFrame] = None,
        benchmark_nav: Optional[pd.DataFrame] = None,
        yearly_breakdown: Optional[pd.DataFrame] = None,
    ...
    def _check_ic_ir(self, rank_ic: Optional[pd.DataFrame]) -> tuple[float, GateCheck]:
        """Gate 2: IC IR > 阈值"""
    ...
    def _check_monotonicity(self, quantile_summary: Optional[pd.DataFrame]) -> tuple[float, GateCheck]:
        """Gate 3: 分组单调性 > 阈值"""
    ...
    def _check_excess_return(self, nav: pd.DataFrame, benchmark_nav: Optional[pd.DataFrame]) -> tuple[float, GateCheck]:
        """Gate 4: 成本后超额收益 > 阈值"""
    ...
    def _check_yearly_stability(self, yearly_breakdown: Optional[pd.DataFrame]) -> tuple[float, GateCheck]:
        """Gate 7: 分年度稳定性"""
